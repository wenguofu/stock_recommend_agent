                  ...
                  <tr key={stock.code} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => handleOpenPaperPlan(stock)}
                          className="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-700 transition-colors"
                        >
                          📋 计划
                        </button>
                      </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-hidden flex flex-col">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                添加到模拟盘 - {paperTargetStock.name} ({paperTargetStock.code})
              </h2>
              <button
                onClick={() => { setShowPaperModal(false); setPaperError(null); }}
                className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              ...
              <div>
                ...
                {paperAccountsLoading ? (
                  ...
                  <select
                    ...
                    onChange={(e) => setSelectedPaperAccountId(e.target.value ? Number(e.target.value) : null)}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  买入数量 <span className="text-gray-400 font-normal">（留空自动计算）</span>
                </label>
                <input
                  type="number"
                  value={paperQuantity}
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
